...
function eliminar(marId) {

  $.ajax({
			type: 'POST',
			url: 'DeleteMarcaServlet',
			data: {marId : marId},
			statusCode: {
				404: function(){
...
<script>
		...
		$.ajax({
			...
			success: function(response){
					 ...
					 document.getElementById("table_productos").innerHTML="<table class='table table-bordered' id='table_productos'><thead class='thead-dark'><tr><th width= '10%'>ID</th><th width= '15%'>MARCA</th><th width= '5%'>OPC</th></tr></thead></table>";
					...
					for(var i = 0; i< separado.length -1; i++) {
						...
						var marDescripcion = separado[i].split("|")[1];
						
						$('table[id=table_productos]').append('<tr><td width= "10%"> '+idMarca+'</td><td width= "60%" contenteditable="true">'+marDescripcion+'</td><td width= "10%"><span class="glyphicon glyphicon-remove" id="delete" onclick="eliminar('+idMarca+')"></span></td></tr>')
...
$(document).ready(function(){
	...
	$('#table_productos tr').each(function (index){
		...
		alert("La marca fue creada correctamente");
      ...
      <div class="container-fluid">
         ...
         <div class="collapse navbar-collapse" id="bs-sidebar-navbar-collapse-1">
            ...
            <ul class="sub-menu collapse nav navbar-nav" id="service">
               ...
               <li  class="active"><a href="CrearMarca.jsp">Crear Marca<span style="font-size:16px;" class="pull-right hidden-xs showopacity glyphicon glyphicon-eye-open"></span></a></li>
