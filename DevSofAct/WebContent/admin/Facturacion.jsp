...
$(document).ready(function(){
	...
	var params = {
						medida : $('select[name=producto]').val(),  tipo  : 'A'
						};
		$.ajax({
			type: 'GET',
			url: 'MedidaServlet',
		...
		$.ajax({
			...
			success: function(response){
				...
				for(var i = 0; i< separado.length -1; i++){
					...
					var fila = $("#table_productos tr").length;
					$('table[id=table_productos]').append('<tr ><td width= "10%" id=>'+cantidad+'</td><td width= "12%">'+referencia+' </td><td width= "12%">'+marca+'</td><td width= "30%">'+tipo_p + " "+producto+ " "+ observacion+' </td><td width= "10%">'+medi+'</td><td width= "10%">'+descuento+'</td> <td width= "10%">'+valorDescuento+'</td><td width= "14%">'+total+'</td><td width= "7%"><span class="glyphicon glyphicon-pencil" onclick="agregar()"></span><span class="glyphicon glyphicon-remove" id="delete" ></span></td><td style="display: none;">'+pvmId+'</td><td style="display: none;">'+descuento+'</td></tr>')
...
<div class="col-xs-12">
	<table>
		<tr>
			<td width="50%"></td>
			<td width="50%"><img src="./admin/SofActBlue.png" width="170px"
				height="50px">
			<td width="50%">
				<div>
...
<body>
	...
	<div id=centro>
			...
			<div class="collapse navbar-collapse"
				...
				<ul class="nav navbar-nav">
					...
					<ul class="sub-menu collapse nav navbar-nav" id="service">
						...
						<li><a href="UpdateProducto.jsp">Actualizar Producto<span
								style="font-size: 16px;"
								class="pull-right hidden-xs showopacity glyphicon glyphicon-usd"></span></a></li>
		...
		<div id="nuevoClienteDiv">
			<a id="nuevoCliente" name="nuevoCliente" class="btn btn-info btn-sm">
		...
		<table id="tabla_form">
			...
			<tr>
				<td><label for="usr"><span class="red"> *</span>Descuento
						(%): </label></td>
				<td><input type="number" class="form-control" id="descuento"
					value="0"></td>
				<td><label for="usr"><span class="red"> *</span>Valor
						Calculado: </label></td>
			...
			<tr>
				<td><label for="usr"><span class="red"> *</span>Valor
						Original: </label></td>
				<td><input type="number" class="form-control" id="original"
					value="0"></td>

				<td><label for="usr"><span class="red"> *</span>Existencias:</label>
				</td>
				<td><input type="number" class="form-control" id="existencia"
					disabled="true"></td>
			</tr>
			<tr>
				<td>
		...
		<div class="col-xs-12" style="display: none;" id="divObservaciones">
			<table align="center">
				<tr>
					...
					<td><textarea rows="4" cols="100" id="textObservacion"></textarea>
					</td>
				</tr>
			</table>
		</div>
