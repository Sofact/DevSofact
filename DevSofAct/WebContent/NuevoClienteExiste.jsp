      ...
      <ul class="nav navbar-nav">
        ...
        <li data-toggle="collapse" data-target="#service" class="collapsed" ><a >Administración<span style="font-size:16px;" class="pull-right hidden-xs showopacity glyphicon glyphicon-cog"></span></a></li>
      		 <ul class="sub-menu collapse nav navbar-nav" id="service"> 
                  <li class="active"><a href="Facturacion.jsp">Crear Cliente<span style="font-size:16px;" class="pull-right hidden-xs showopacity glyphicon glyphicon-globe"></span></a></li>
                  ...
                  <li ><a href="Facturacion.jsp">Crear Marca<span style="font-size:16px;" class="pull-right hidden-xs showopacity glyphicon glyphicon-eye-open"></span></a></li>
                  <li ><a href="Facturacion.jsp">Crear Medida<span style="font-size:16px;" class="pull-right hidden-xs showopacity glyphicon glyphicon-wrench"></span></a></li>
	     ...
	     <form class="form-horizontal" method="POST" action="./SaveClientServlet">
	      <div><h5 style="color: red; font-weight: bold;">El número de identificación ya se encontraba registrado</h5></div>
	      <br>
