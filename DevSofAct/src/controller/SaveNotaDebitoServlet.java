...
/**
 * Servlet implementation class SaveNotaDebitoServlet
 */
@WebServlet("/SaveNotaDebitoServlet")
public class SaveNotaDebitoServlet extends HttpServlet {
	private static final long serialVersionUID = 1L;
       
    /**
     * @see HttpServlet#HttpServlet()
     */
    public SaveNotaDebitoServlet() {
        super();
	...
	protected void doPost(HttpServletRequest request, HttpServletResponse response) throws ServletException, IOException {
		...
		try {
			...
			rns.processRequestDebito(request, response, id);
