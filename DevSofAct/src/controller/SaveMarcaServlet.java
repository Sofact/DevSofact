...
/**
 * Servlet implementation class SaveMarcaServlet
 */
@WebServlet("/SaveMarcaServlet")
	...
	protected void doPost(HttpServletRequest request, HttpServletResponse response) throws ServletException, IOException {
		...
		try {
			...
			for (Parametro tipo : prod.getParametro()) {
				...
				int idDetalle = gd.getMarcaDesc(descripcion);
				
				if(idDetalle < 0) {
					idDetalle = sd.SaveData(tipo, "marca");		
				}	
			}
